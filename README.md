# 🖤 Rashboard — Shortcut Manager Dashboard
...
For users who want a clean dashboard to organize all their shortcuts, or who hate having multiple apps, shortcuts, or links on thier desktop or home screen.
...
- Touch-friendly long-press menus on mobile
- Right-click context menus on desktop
- Seamless experience across all modern browsers

### 🔗 Shortcut Management
- Add, edit, and delete shortcuts instantly
...
### 🎨 Customizable Icons
- Choose from multiple built-in color themes
...
- Clean context menus for quick actions
...
- Anyone who doesn't want multiple apps, shortcuts or links on thier desktop or home screen 

---

## 📦 Getting Started
1. Clone the site, install the app, or just use the link
